...
pbxProject.prototype.addBuildPhase = function(filePathsArray, buildPhaseType, comment, target, folderType, subfolderPath, shellScript) {
    ...
    if (buildPhaseType === 'PBXShellScriptBuildPhase') {
        ...
        buildPhase.shellScript = "\"" + (shellScript || "").replace(/\"/g, "\\\"") + "\"";
    }
